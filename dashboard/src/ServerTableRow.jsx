...
export const ServerTableRow = ({state, name, ports, link, onStart, onStop}) => {
    ...
    return <TableRow>
        ...
        <TableRowColumn>
            <RaisedButton label="Start" primary={true} disabled={!canStart} style={{margin: "8px"}} onClick={onStart}/>
            <RaisedButton label="Stop" secondary={true} disabled={!canStop} style={{margin: "8px"}} onClick={onStop}/>
